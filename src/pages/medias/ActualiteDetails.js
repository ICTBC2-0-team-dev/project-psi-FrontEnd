...
const ActualiteDetails = () => {
    ...
    React.useEffect(() => {
        const fetchActualite = async () => {
            try {
                const response = await axios.get(`http://localhost:8081/actualite/${id}`);
    ...
    React.useEffect(() => {
        const fetchProjects = async () => {
            try {
                ...
                setActualiteConnexes(response.data.slice(-2));
                console.log(response.data);
            } catch (error) {
                console.log(error);
            }
                ...
                <div className="row-2 d-flex justify-content-center align-items-center">
                    {!firstActualite ? (
                        ...
                        <div className="col-md-3" style={{ width: '70%' }} >
                            ...
                            <div>
                                <img className="rectangle" alt="Rectangle" src={`http://localhost:8081/${firstActualite.image}`} />
