...
const CommandeProduit = () => {
        ...
        if (selectedIdImagerie) {
            axios.delete(`/article/${selectedIdImagerie}`)
                .then(response => {
                    ...
                    alert('Article supprimer avec sucess')
    ...
    const handleValiderClickmetheorologique = async () => {
        ...
        if (selectedIdmetheorologique) {
            axios.put(`/article/${selectedIdmetheorologique}`)
                .then(response => {
                    console.log('Article supprimer avec sucess:', response.data);
                                        ...
                                        <div className='col-4'>
                                            ...
                                            >
                                                <Fade in={openModalImagerie}>
                                                    <Box sx={style}>
                                                        <div class="alert alert-danger text-center" role="alert" fontWeight="bold">
                                                            Alert voulez vous supprimer l'article correspondant ?
                                                        </div>
